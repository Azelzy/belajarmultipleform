...
{
    public partial class FormBiodatadiri : Form
    {
        public FormBiodatadiri()
        {
            InitializeComponent();
        }
        ...
        private void btnapply_Click(object sender, EventArgs e)
        {
            ...
            if (rblaki.Checked)
            { kelamin += "laki-laki"; }
            else if (rbprempuan.Checked)
            { kelamin += "perempuan"; }
            labelhasil.Visible = true;
            labelhasil.Text = ("Nama: " + txtnamalengkap.Text + "\n Jenis kelamin: " + kelamin + "\n Kelas: " + cmbkelas.Text + "\n Absen: " + cmbabsen.Text);
        }
